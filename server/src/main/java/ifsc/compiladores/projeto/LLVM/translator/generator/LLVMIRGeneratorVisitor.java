...
import ifsc.compiladores.projeto.LLVM.translator.definitions.conversions.ConversionCreator;
import ifsc.compiladores.projeto.LLVM.translator.definitions.conversions.NormalizedVariablesReturnableFragmentBlock;
import ifsc.compiladores.projeto.LLVM.translator.definitions.expressions.Constant;
...
import ifsc.compiladores.projeto.LLVM.translator.definitions.functions.FunctionCall;
import ifsc.compiladores.projeto.LLVM.translator.definitions.functions.Parameter;
import ifsc.compiladores.projeto.LLVM.translator.definitions.io.Println;
import ifsc.compiladores.projeto.LLVM.translator.definitions.io.PrintlnDeclaration;
import ifsc.compiladores.projeto.LLVM.translator.definitions.io.Scanf;
import ifsc.compiladores.projeto.LLVM.translator.definitions.io.ScanfDeclaration;
import ifsc.compiladores.projeto.LLVM.translator.definitions.jumps.ConditionalJump;
...
import ifsc.compiladores.projeto.LLVM.translator.scopeManager.ScopeManager;
import ifsc.compiladores.projeto.LLVM.translator.scopeManager.SingleUseVariablesManager;
...
public class LLVMIRGeneratorVisitor extends ParserGrammarBaseVisitor<Fragment> {
    ...
    public FragmentBlock visitComandoLinhaLeitura(ParserGrammar.ComandoLinhaLeituraContext ctx) {
        ...
        else if (scanVariable.type().getBaseType() == BaseType.CHAR) {
            scanfTemplate = " %c";
        }
        else {
            scanfTemplate = "%d";
